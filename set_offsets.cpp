...
CCSPlayerController_InventoryServices.m_vecNetworkableLoadout = findOffsetByName(j, "CCSPlayerController_InventoryServices", "m_vecNetworkableLoadout");
...
// CTriggerFan Offsets
CTriggerFan.m_vFanOriginOffset = findOffsetByName(j, "CTriggerFan", "m_vFanOriginOffset");
CTriggerFan.m_vDirection = findOffsetByName(j, "CTriggerFan", "m_vDirection");
CTriggerFan.m_bPushTowardsInfoTarget = findOffsetByName(j, "CTriggerFan", "m_bPushTowardsInfoTarget");
CTriggerFan.m_bPushAwayFromInfoTarget = findOffsetByName(j, "CTriggerFan", "m_bPushAwayFromInfoTarget");
CTriggerFan.m_qNoiseDelta = findOffsetByName(j, "CTriggerFan", "m_qNoiseDelta");
CTriggerFan.m_hInfoFan = findOffsetByName(j, "CTriggerFan", "m_hInfoFan");
...
CTriggerFan.m_vFanOriginWS = findOffsetByName(j, "CTriggerFan", "m_vFanOriginWS");
CTriggerFan.m_vFanOriginLS = findOffsetByName(j, "CTriggerFan", "m_vFanOriginLS");
CTriggerFan.m_vFanEndLS = findOffsetByName(j, "CTriggerFan", "m_vFanEndLS");
CTriggerFan.m_vNoiseDirectionTarget = findOffsetByName(j, "CTriggerFan", "m_vNoiseDirectionTarget");
CTriggerFan.m_iszInfoFan = findOffsetByName(j, "CTriggerFan", "m_iszInfoFan");
CTriggerFan.m_flRopeForceScale = findOffsetByName(j, "CTriggerFan", "m_flRopeForceScale");
CTriggerFan.m_flParticleForceScale = findOffsetByName(j, "CTriggerFan", "m_flParticleForceScale");
CTriggerFan.m_flPlayerForce = findOffsetByName(j, "CTriggerFan", "m_flPlayerForce");
CTriggerFan.m_bPlayerWindblock = findOffsetByName(j, "CTriggerFan", "m_bPlayerWindblock");
CTriggerFan.m_flNPCForce = findOffsetByName(j, "CTriggerFan", "m_flNPCForce");
CTriggerFan.m_flRampTime = findOffsetByName(j, "CTriggerFan", "m_flRampTime");
CTriggerFan.m_fNoiseDegrees = findOffsetByName(j, "CTriggerFan", "m_fNoiseDegrees");
CTriggerFan.m_fNoiseSpeed = findOffsetByName(j, "CTriggerFan", "m_fNoiseSpeed");
...
CTriggerFan.m_nManagerFanIdx = findOffsetByName(j, "CTriggerFan", "m_nManagerFanIdx");
...
C_EnvVolumetricFogVolume.m_bIndirectUseLPVs = findOffsetByName(j, "C_EnvVolumetricFogVolume", "m_bIndirectUseLPVs");
...
C_EnvVolumetricFogVolume.m_TintColor = findOffsetByName(j, "C_EnvVolumetricFogVolume", "m_TintColor");
C_EnvVolumetricFogVolume.m_bOverrideTintColor = findOffsetByName(j, "C_EnvVolumetricFogVolume", "m_bOverrideTintColor");
...
// Atribuições para CPulseCell_PlaySequence
// CPulseCell_PlaySequence Offsets
CPulseCell_PlaySequence.m_SequenceName = findOffsetByName(j, "CPulseCell_PlaySequence", "m_SequenceName");
CPulseCell_PlaySequence.m_PulseAnimEvents = findOffsetByName(j, "CPulseCell_PlaySequence", "m_PulseAnimEvents");
CPulseCell_PlaySequence.m_OnFinished = findOffsetByName(j, "CPulseCell_PlaySequence", "m_OnFinished");
CPulseCell_PlaySequence.m_OnCanceled = findOffsetByName(j, "CPulseCell_PlaySequence", "m_OnCanceled");
...
C_BarnLight.m_nLightPathUniqueId = findOffsetByName(j, "C_BarnLight", "m_nLightPathUniqueId");
C_BarnLight.m_nLightMapUniqueId = findOffsetByName(j, "C_BarnLight", "m_nLightMapUniqueId");
...
// Atribuições para CPulseCell_LerpCameraSettings
// CPulseCell_LerpCameraSettings Offsets
CPulseCell_LerpCameraSettings.m_flSeconds = findOffsetByName(j, "CPulseCell_LerpCameraSettings", "m_flSeconds");
CPulseCell_LerpCameraSettings.m_Start = findOffsetByName(j, "CPulseCell_LerpCameraSettings", "m_Start");
CPulseCell_LerpCameraSettings.m_End = findOffsetByName(j, "CPulseCell_LerpCameraSettings", "m_End");
...
// CInfoFan Offsets
CInfoFan.m_fFanForceMaxRadius = findOffsetByName(j, "CInfoFan", "m_fFanForceMaxRadius");
CInfoFan.m_fFanForceMinRadius = findOffsetByName(j, "CInfoFan", "m_fFanForceMinRadius");
CInfoFan.m_flCurveDistRange = findOffsetByName(j, "CInfoFan", "m_flCurveDistRange");
CInfoFan.m_FanForceCurveString = findOffsetByName(j, "CInfoFan", "m_FanForceCurveString");
...
C_CSPlayerPawnBase.m_flClientHealthFadeChangeTimestamp = findOffsetByName(j, "C_CSPlayerPawnBase", "m_flClientHealthFadeChangeTimestamp");
C_CSPlayerPawnBase.m_nClientHealthFadeParityValue = findOffsetByName(j, "C_CSPlayerPawnBase", "m_nClientHealthFadeParityValue");
...
C_BreakableProp.m_OnStartDeath = findOffsetByName(j, "C_BreakableProp", "m_OnStartDeath");
...
// Atribuições para CPulseCell_Step_EntFire
// CPulseCell_Step_EntFire Offsets
CPulseCell_Step_EntFire.m_Input = findOffsetByName(j, "CPulseCell_Step_EntFire", "m_Input");
...
C_EnvVolumetricFogController.m_TintColor = findOffsetByName(j, "C_EnvVolumetricFogController", "m_TintColor");
...
C_EnvVolumetricFogController.m_fWindSpeed = findOffsetByName(j, "C_EnvVolumetricFogController", "m_fWindSpeed");
...
// Atribuições para C_EnvWindVolume
// C_EnvWindVolume Offsets
C_EnvWindVolume.m_bActive = findOffsetByName(j, "C_EnvWindVolume", "m_bActive");
C_EnvWindVolume.m_vBoxMins = findOffsetByName(j, "C_EnvWindVolume", "m_vBoxMins");
C_EnvWindVolume.m_vBoxMaxs = findOffsetByName(j, "C_EnvWindVolume", "m_vBoxMaxs");
C_EnvWindVolume.m_bStartDisabled = findOffsetByName(j, "C_EnvWindVolume", "m_bStartDisabled");
C_EnvWindVolume.m_nShape = findOffsetByName(j, "C_EnvWindVolume", "m_nShape");
C_EnvWindVolume.m_fWindSpeedMultiplier = findOffsetByName(j, "C_EnvWindVolume", "m_fWindSpeedMultiplier");
C_EnvWindVolume.m_fWindTurbulenceMultiplier = findOffsetByName(j, "C_EnvWindVolume", "m_fWindTurbulenceMultiplier");
C_EnvWindVolume.m_fWindSpeedVariationMultiplier = findOffsetByName(j, "C_EnvWindVolume", "m_fWindSpeedVariationMultiplier");
C_EnvWindVolume.m_fWindDirectionVariationMultiplier = findOffsetByName(j, "C_EnvWindVolume", "m_fWindDirectionVariationMultiplier");
...
CBuoyancyHelper.m_flNeutrallyBuoyantGravity = findOffsetByName(j, "CBuoyancyHelper", "m_flNeutrallyBuoyantGravity");
CBuoyancyHelper.m_flNeutrallyBuoyantLinearDamping = findOffsetByName(j, "CBuoyancyHelper", "m_flNeutrallyBuoyantLinearDamping");
CBuoyancyHelper.m_flNeutrallyBuoyantAngularDamping = findOffsetByName(j, "CBuoyancyHelper", "m_flNeutrallyBuoyantAngularDamping");
CBuoyancyHelper.m_bNeutrallyBuoyant = findOffsetByName(j, "CBuoyancyHelper", "m_bNeutrallyBuoyant");
...
C_CSWeaponBase.m_iWeaponGameplayAnimState = findOffsetByName(j, "C_CSWeaponBase", "m_iWeaponGameplayAnimState");
C_CSWeaponBase.m_flWeaponGameplayAnimStateTimestamp = findOffsetByName(j, "C_CSWeaponBase", "m_flWeaponGameplayAnimStateTimestamp");
C_CSWeaponBase.m_flInspectCancelCompleteTime = findOffsetByName(j, "C_CSWeaponBase", "m_flInspectCancelCompleteTime");
C_CSWeaponBase.m_bInspectPending = findOffsetByName(j, "C_CSWeaponBase", "m_bInspectPending");
C_CSWeaponBase.m_bInspectShouldLoop = findOffsetByName(j, "C_CSWeaponBase", "m_bInspectShouldLoop");
...
C_CSWeaponBase.m_bWasActiveWeaponWhenDropped = findOffsetByName(j, "C_CSWeaponBase", "m_bWasActiveWeaponWhenDropped");
...
C_CSWeaponBase.m_flLastShakeTime = findOffsetByName(j, "C_CSWeaponBase", "m_flLastShakeTime");
...
C_CSPlayerPawn.m_hHudModelArms = findOffsetByName(j, "C_CSPlayerPawn", "m_hHudModelArms");
...
C_CSPlayerPawn.m_bShouldAutobuyDMWeapons = findOffsetByName(j, "C_CSPlayerPawn", "m_bShouldAutobuyDMWeapons");
C_CSPlayerPawn.m_fImmuneToGunGameDamageTime = findOffsetByName(j, "C_CSPlayerPawn", "m_fImmuneToGunGameDamageTime");
C_CSPlayerPawn.m_bGunGameImmunity = findOffsetByName(j, "C_CSPlayerPawn", "m_bGunGameImmunity");
C_CSPlayerPawn.m_fImmuneToGunGameDamageTimeLast = findOffsetByName(j, "C_CSPlayerPawn", "m_fImmuneToGunGameDamageTimeLast");
C_CSPlayerPawn.m_fMolotovDamageTime = findOffsetByName(j, "C_CSPlayerPawn", "m_fMolotovDamageTime");
C_CSPlayerPawn.m_vecLastAliveLocalVelocity = findOffsetByName(j, "C_CSPlayerPawn", "m_vecLastAliveLocalVelocity");
C_CSPlayerPawn.m_fRenderingClipPlane = findOffsetByName(j, "C_CSPlayerPawn", "m_fRenderingClipPlane");
C_CSPlayerPawn.m_nLastClipPlaneSetupFrame = findOffsetByName(j, "C_CSPlayerPawn", "m_nLastClipPlaneSetupFrame");
C_CSPlayerPawn.m_vecLastClipCameraPos = findOffsetByName(j, "C_CSPlayerPawn", "m_vecLastClipCameraPos");
C_CSPlayerPawn.m_vecLastClipCameraForward = findOffsetByName(j, "C_CSPlayerPawn", "m_vecLastClipCameraForward");
C_CSPlayerPawn.m_bClipHitStaticWorld = findOffsetByName(j, "C_CSPlayerPawn", "m_bClipHitStaticWorld");
C_CSPlayerPawn.m_bCachedPlaneIsValid = findOffsetByName(j, "C_CSPlayerPawn", "m_bCachedPlaneIsValid");
C_CSPlayerPawn.m_pClippingWeapon = findOffsetByName(j, "C_CSPlayerPawn", "m_pClippingWeapon");
C_CSPlayerPawn.m_nPlayerInfernoBodyFx = findOffsetByName(j, "C_CSPlayerPawn", "m_nPlayerInfernoBodyFx");
C_CSPlayerPawn.m_angEyeAngles = findOffsetByName(j, "C_CSPlayerPawn", "m_angEyeAngles");
C_CSPlayerPawn.m_arrOldEyeAnglesTimes = findOffsetByName(j, "C_CSPlayerPawn", "m_arrOldEyeAnglesTimes");
C_CSPlayerPawn.m_arrOldEyeAngles = findOffsetByName(j, "C_CSPlayerPawn", "m_arrOldEyeAngles");
C_CSPlayerPawn.m_angEyeAnglesVelocity = findOffsetByName(j, "C_CSPlayerPawn", "m_angEyeAnglesVelocity");
C_CSPlayerPawn.m_iIDEntIndex = findOffsetByName(j, "C_CSPlayerPawn", "m_iIDEntIndex");
C_CSPlayerPawn.m_delayTargetIDTimer = findOffsetByName(j, "C_CSPlayerPawn", "m_delayTargetIDTimer");
...
CGameSceneNode.m_vecWrappedLocalOrigin = findOffsetByName(j, "CGameSceneNode", "m_vecWrappedLocalOrigin");
CGameSceneNode.m_angWrappedLocalRotation = findOffsetByName(j, "CGameSceneNode", "m_angWrappedLocalRotation");
CGameSceneNode.m_flWrappedScale = findOffsetByName(j, "CGameSceneNode", "m_flWrappedScale");
...
C_EnvWindController.m_fDirectionVariation = findOffsetByName(j, "C_EnvWindController", "m_fDirectionVariation");
C_EnvWindController.m_fSpeedVariation = findOffsetByName(j, "C_EnvWindController", "m_fSpeedVariation");
C_EnvWindController.m_fTurbulence = findOffsetByName(j, "C_EnvWindController", "m_fTurbulence");
C_EnvWindController.m_fVolumeHalfExtentXY = findOffsetByName(j, "C_EnvWindController", "m_fVolumeHalfExtentXY");
C_EnvWindController.m_fVolumeHalfExtentZ = findOffsetByName(j, "C_EnvWindController", "m_fVolumeHalfExtentZ");
C_EnvWindController.m_nVolumeResolutionXY = findOffsetByName(j, "C_EnvWindController", "m_nVolumeResolutionXY");
C_EnvWindController.m_nVolumeResolutionZ = findOffsetByName(j, "C_EnvWindController", "m_nVolumeResolutionZ");
C_EnvWindController.m_nClipmapLevels = findOffsetByName(j, "C_EnvWindController", "m_nClipmapLevels");
C_EnvWindController.m_bIsMaster = findOffsetByName(j, "C_EnvWindController", "m_bIsMaster");
C_EnvWindController.m_bFirstTime = findOffsetByName(j, "C_EnvWindController", "m_bFirstTime");
...
C_CSGO_MapPreviewCameraPath.m_bDofEnabled = findOffsetByName(j, "C_CSGO_MapPreviewCameraPath", "m_bDofEnabled");
C_CSGO_MapPreviewCameraPath.m_flDofNearBlurry = findOffsetByName(j, "C_CSGO_MapPreviewCameraPath", "m_flDofNearBlurry");
C_CSGO_MapPreviewCameraPath.m_flDofNearCrisp = findOffsetByName(j, "C_CSGO_MapPreviewCameraPath", "m_flDofNearCrisp");
C_CSGO_MapPreviewCameraPath.m_flDofFarCrisp = findOffsetByName(j, "C_CSGO_MapPreviewCameraPath", "m_flDofFarCrisp");
C_CSGO_MapPreviewCameraPath.m_flDofFarBlurry = findOffsetByName(j, "C_CSGO_MapPreviewCameraPath", "m_flDofFarBlurry");
C_CSGO_MapPreviewCameraPath.m_flDofTiltToGround = findOffsetByName(j, "C_CSGO_MapPreviewCameraPath", "m_flDofTiltToGround");
...
C_BasePropDoor.m_bNoNPCs = findOffsetByName(j, "C_BasePropDoor", "m_bNoNPCs");
...
C_BaseModelEntity.m_bvDisabledHitGroups = findOffsetByName(j, "C_BaseModelEntity", "m_bvDisabledHitGroups");
...
C_EnvCombinedLightProbeVolume.m_Entity_hLightProbeTexture_AmbientCube = findOffsetByName(j, "C_EnvCombinedLightProbeVolume", "m_Entity_hLightProbeTexture_AmbientCube");
C_EnvCombinedLightProbeVolume.m_Entity_hLightProbeTexture_SDF = findOffsetByName(j, "C_EnvCombinedLightProbeVolume", "m_Entity_hLightProbeTexture_SDF");
C_EnvCombinedLightProbeVolume.m_Entity_hLightProbeTexture_SH2_DC = findOffsetByName(j, "C_EnvCombinedLightProbeVolume", "m_Entity_hLightProbeTexture_SH2_DC");
C_EnvCombinedLightProbeVolume.m_Entity_hLightProbeTexture_SH2_R = findOffsetByName(j, "C_EnvCombinedLightProbeVolume", "m_Entity_hLightProbeTexture_SH2_R");
C_EnvCombinedLightProbeVolume.m_Entity_hLightProbeTexture_SH2_G = findOffsetByName(j, "C_EnvCombinedLightProbeVolume", "m_Entity_hLightProbeTexture_SH2_G");
C_EnvCombinedLightProbeVolume.m_Entity_hLightProbeTexture_SH2_B = findOffsetByName(j, "C_EnvCombinedLightProbeVolume", "m_Entity_hLightProbeTexture_SH2_B");
...
C_BaseEntity.m_flDamageAccumulator = findOffsetByName(j, "C_BaseEntity", "m_flDamageAccumulator");
...
C_BaseEntity.m_vecServerVelocity = findOffsetByName(j, "C_BaseEntity", "m_vecServerVelocity");
...
C_BaseEntity.m_bGravityDisabled = findOffsetByName(j, "C_BaseEntity", "m_bGravityDisabled");
...
C_BaseEntity.m_flActualGravityScale = findOffsetByName(j, "C_BaseEntity", "m_flActualGravityScale");
C_BaseEntity.m_bGravityActuallyDisabled = findOffsetByName(j, "C_BaseEntity", "m_bGravityActuallyDisabled");
...
C_BasePlayerPawn.m_hDefaultController = findOffsetByName(j, "C_BasePlayerPawn", "m_hDefaultController");
...
CCSWeaponBaseVData.m_bReloadsSingleShells = findOffsetByName(j, "CCSWeaponBaseVData", "m_bReloadsSingleShells");
...
CCSWeaponBaseVData.m_flDeployDuration = findOffsetByName(j, "CCSWeaponBaseVData", "m_flDeployDuration");
CCSWeaponBaseVData.m_flDisallowAttackAfterReloadStartDuration = findOffsetByName(j, "CCSWeaponBaseVData", "m_flDisallowAttackAfterReloadStartDuration");
CCSWeaponBaseVData.m_nBurstShotCount = findOffsetByName(j, "CCSWeaponBaseVData", "m_nBurstShotCount");
CCSWeaponBaseVData.m_bAllowBurstHolster = findOffsetByName(j, "CCSWeaponBaseVData", "m_bAllowBurstHolster");
...
C_WeaponBaseItem.m_bSequenceInProgress = findOffsetByName(j, "C_WeaponBaseItem", "m_bSequenceInProgress");
...
PhysicsRagdollPose_t.m_bSetFromDebugHistory = findOffsetByName(j, "PhysicsRagdollPose_t", "m_bSetFromDebugHistory");
...
C_WeaponCZ75a.m_bMagazineRemoved = findOffsetByName(j, "C_WeaponCZ75a", "m_bMagazineRemoved");
...
// Atribuições para CPointOrient
// CPointOrient Offsets
CPointOrient.m_iszSpawnTargetName = findOffsetByName(j, "CPointOrient", "m_iszSpawnTargetName");
CPointOrient.m_hTarget = findOffsetByName(j, "CPointOrient", "m_hTarget");
CPointOrient.m_bActive = findOffsetByName(j, "CPointOrient", "m_bActive");
CPointOrient.m_nGoalDirection = findOffsetByName(j, "CPointOrient", "m_nGoalDirection");
CPointOrient.m_nConstraint = findOffsetByName(j, "CPointOrient", "m_nConstraint");
CPointOrient.m_flMaxTurnRate = findOffsetByName(j, "CPointOrient", "m_flMaxTurnRate");
CPointOrient.m_flLastGameTime = findOffsetByName(j, "CPointOrient", "m_flLastGameTime");
...
CCSPlayerController_ActionTrackingServices.m_flTotalRoundDamageDealt = findOffsetByName(j, "CCSPlayerController_ActionTrackingServices", "m_flTotalRoundDamageDealt");
...
CSMatchStats_t.m_flHealthPointsRemovedTotal = findOffsetByName(j, "CSMatchStats_t", "m_flHealthPointsRemovedTotal");
CSMatchStats_t.m_flHealthPointsDealtTotal = findOffsetByName(j, "CSMatchStats_t", "m_flHealthPointsDealtTotal");
...
CModelState.m_nBodyGroupChoices = findOffsetByName(j, "CModelState", "m_nBodyGroupChoices");
...
// Atribuições para CPulseCell_LerpCameraSettings__CursorState_t
// CPulseCell_LerpCameraSettings__CursorState_t Offsets
...
C_CSWeaponBaseGun.m_nRevolverCylinderIdx = findOffsetByName(j, "C_CSWeaponBaseGun", "m_nRevolverCylinderIdx");
...
CPulseCell_PlaySequence__CursorState_t.m_hTarget = findOffsetByName(j, "CPulseCell_PlaySequence__CursorState_t", "m_hTarget");
...
C_BaseTrigger.m_OnStartTouch = findOffsetByName(j, "C_BaseTrigger", "m_OnStartTouch");
C_BaseTrigger.m_OnStartTouchAll = findOffsetByName(j, "C_BaseTrigger", "m_OnStartTouchAll");
C_BaseTrigger.m_OnEndTouch = findOffsetByName(j, "C_BaseTrigger", "m_OnEndTouch");
C_BaseTrigger.m_OnEndTouchAll = findOffsetByName(j, "C_BaseTrigger", "m_OnEndTouchAll");
C_BaseTrigger.m_OnTouching = findOffsetByName(j, "C_BaseTrigger", "m_OnTouching");
C_BaseTrigger.m_OnTouchingEachEntity = findOffsetByName(j, "C_BaseTrigger", "m_OnTouchingEachEntity");
C_BaseTrigger.m_OnNotTouching = findOffsetByName(j, "C_BaseTrigger", "m_OnNotTouching");
C_BaseTrigger.m_hTouchingEntities = findOffsetByName(j, "C_BaseTrigger", "m_hTouchingEntities");
C_BaseTrigger.m_iFilterName = findOffsetByName(j, "C_BaseTrigger", "m_iFilterName");
C_BaseTrigger.m_hFilter = findOffsetByName(j, "C_BaseTrigger", "m_hFilter");
...
// Atribuições para CCSPlayerController_InventoryServices__NetworkedLoadoutSlot_t
// CCSPlayerController_InventoryServices__NetworkedLoadoutSlot_t Offsets
CCSPlayerController_InventoryServices__NetworkedLoadoutSlot_t.pItem = findOffsetByName(j, "CCSPlayerController_InventoryServices__NetworkedLoadoutSlot_t", "pItem");
CCSPlayerController_InventoryServices__NetworkedLoadoutSlot_t.team = findOffsetByName(j, "CCSPlayerController_InventoryServices__NetworkedLoadoutSlot_t", "team");
CCSPlayerController_InventoryServices__NetworkedLoadoutSlot_t.slot = findOffsetByName(j, "CCSPlayerController_InventoryServices__NetworkedLoadoutSlot_t", "slot");
...
CLightComponent.m_nLightPathUniqueId = findOffsetByName(j, "CLightComponent", "m_nLightPathUniqueId");
CLightComponent.m_nLightMapUniqueId = findOffsetByName(j, "CLightComponent", "m_nLightMapUniqueId");
...
CDamageRecord.m_flBulletsDamage = findOffsetByName(j, "CDamageRecord", "m_flBulletsDamage");
CDamageRecord.m_flDamage = findOffsetByName(j, "CDamageRecord", "m_flDamage");
CDamageRecord.m_flActualHealthRemoved = findOffsetByName(j, "CDamageRecord", "m_flActualHealthRemoved");
...
C_CSGameRules.m_iFreezeTime = findOffsetByName(j, "C_CSGameRules", "m_iFreezeTime");
...
// Atribuições para CPulseGameBlackboard
// CPulseGameBlackboard Offsets
CPulseGameBlackboard.m_strGraphName = findOffsetByName(j, "CPulseGameBlackboard", "m_strGraphName");
CPulseGameBlackboard.m_strStateBlob = findOffsetByName(j, "CPulseGameBlackboard", "m_strStateBlob");
...
// CPathSimple Offsets
CPathSimple.m_CPathQueryComponent = findOffsetByName(j, "CPathSimple", "m_CPathQueryComponent");
CPathSimple.m_pathString = findOffsetByName(j, "CPathSimple", "m_pathString");
CPathSimple.m_bClosedLoop = findOffsetByName(j, "CPathSimple", "m_bClosedLoop");
...
fogparams_t.m_bPadding2 = findOffsetByName(j, "fogparams_t", "m_bPadding2");
...
C_EnvLightProbeVolume.m_Entity_hLightProbeTexture_AmbientCube = findOffsetByName(j, "C_EnvLightProbeVolume", "m_Entity_hLightProbeTexture_AmbientCube");
C_EnvLightProbeVolume.m_Entity_hLightProbeTexture_SDF = findOffsetByName(j, "C_EnvLightProbeVolume", "m_Entity_hLightProbeTexture_SDF");
C_EnvLightProbeVolume.m_Entity_hLightProbeTexture_SH2_DC = findOffsetByName(j, "C_EnvLightProbeVolume", "m_Entity_hLightProbeTexture_SH2_DC");
C_EnvLightProbeVolume.m_Entity_hLightProbeTexture_SH2_R = findOffsetByName(j, "C_EnvLightProbeVolume", "m_Entity_hLightProbeTexture_SH2_R");
C_EnvLightProbeVolume.m_Entity_hLightProbeTexture_SH2_G = findOffsetByName(j, "C_EnvLightProbeVolume", "m_Entity_hLightProbeTexture_SH2_G");
C_EnvLightProbeVolume.m_Entity_hLightProbeTexture_SH2_B = findOffsetByName(j, "C_EnvLightProbeVolume", "m_Entity_hLightProbeTexture_SH2_B");
...
CCSPlayer_WeaponServices.m_nOldTotalShootPositionHistoryCount = findOffsetByName(j, "CCSPlayer_WeaponServices", "m_nOldTotalShootPositionHistoryCount");
CCSPlayer_WeaponServices.m_nOldTotalInputHistoryCount = findOffsetByName(j, "CCSPlayer_WeaponServices", "m_nOldTotalInputHistoryCount");
CCSPlayer_WeaponServices.m_networkAnimTiming = findOffsetByName(j, "CCSPlayer_WeaponServices", "m_networkAnimTiming");
CCSPlayer_WeaponServices.m_bBlockInspectUntilNextGraphUpdate = findOffsetByName(j, "CCSPlayer_WeaponServices", "m_bBlockInspectUntilNextGraphUpdate");
...
C_RagdollProp.m_ragEnabled = findOffsetByName(j, "C_RagdollProp", "m_ragEnabled");
...
CBaseAnimGraph.m_bRagdollEnabled = findOffsetByName(j, "CBaseAnimGraph", "m_bRagdollEnabled");
...
CMapInfo.m_flEnvRainStrength = findOffsetByName(j, "CMapInfo", "m_flEnvRainStrength");
CMapInfo.m_flEnvPuddleRippleStrength = findOffsetByName(j, "CMapInfo", "m_flEnvPuddleRippleStrength");
CMapInfo.m_flEnvPuddleRippleDirection = findOffsetByName(j, "CMapInfo", "m_flEnvPuddleRippleDirection");
CMapInfo.m_flEnvWetnessCoverage = findOffsetByName(j, "CMapInfo", "m_flEnvWetnessCoverage");
CMapInfo.m_flEnvWetnessDryingAmount = findOffsetByName(j, "CMapInfo", "m_flEnvWetnessDryingAmount");
...
CBasePlayerWeaponVData.m_szMuzzleFlashParticleConfig = findOffsetByName(j, "CBasePlayerWeaponVData", "m_szMuzzleFlashParticleConfig");
CBasePlayerWeaponVData.m_szBarrelSmokeParticle = findOffsetByName(j, "CBasePlayerWeaponVData", "m_szBarrelSmokeParticle");
...
C_PointClientUIWorldPanel.m_bVisibleWhenParentNoDraw = findOffsetByName(j, "C_PointClientUIWorldPanel", "m_bVisibleWhenParentNoDraw");
...
CBasePlayerController.m_bNoClipEnabled = findOffsetByName(j, "CBasePlayerController", "m_bNoClipEnabled");
...
steamclient64_dll.SteamClient023 = findOffsetByName(j, "steamclient64_dll", "SteamClient023");
...
// Atribuições para vconcomm_dll
// vconcomm_dll Offsets
vconcomm_dll.VConComm001 = findOffsetByName(j, "vconcomm_dll", "VConComm001");
...
CPulseGraphInstance_TestDomain.m_bQuietTracepoints = findOffsetByName(j, "CPulseGraphInstance_TestDomain", "m_bQuietTracepoints");
CPulseGraphInstance_TestDomain.m_bExpectingCursorTerminatedDueToMaxInstructions = findOffsetByName(j, "CPulseGraphInstance_TestDomain", "m_bExpectingCursorTerminatedDueToMaxInstructions");
CPulseGraphInstance_TestDomain.m_nCursorsTerminatedDueToMaxInstructions = findOffsetByName(j, "CPulseGraphInstance_TestDomain", "m_nCursorsTerminatedDueToMaxInstructions");
...
// Atribuições para CPulseCell_ExampleSelector
// CPulseCell_ExampleSelector Offsets
CPulseCell_ExampleSelector.m_OutflowList = findOffsetByName(j, "CPulseCell_ExampleSelector", "m_OutflowList");

// Atribuições para CPulseCell_ExampleCriteria__Criteria_t
// CPulseCell_ExampleCriteria__Criteria_t Offsets
CPulseCell_ExampleCriteria__Criteria_t.m_flFloatValue1 = findOffsetByName(j, "CPulseCell_ExampleCriteria__Criteria_t", "m_flFloatValue1");
CPulseCell_ExampleCriteria__Criteria_t.m_flFloatValue2 = findOffsetByName(j, "CPulseCell_ExampleCriteria__Criteria_t", "m_flFloatValue2");
CPulseCell_ExampleCriteria__Criteria_t.m_bMyBool = findOffsetByName(j, "CPulseCell_ExampleCriteria__Criteria_t", "m_bMyBool");
...
CScriptedSequence.m_nForcedCrouchState = findOffsetByName(j, "CScriptedSequence", "m_nForcedCrouchState");
...
CScriptedSequence.m_bDisableAimingWhileMoving = findOffsetByName(j, "CScriptedSequence", "m_bDisableAimingWhileMoving");
CScriptedSequence.m_bIgnoreRotation = findOffsetByName(j, "CScriptedSequence", "m_bIgnoreRotation");
...
CScriptedSequence.m_flMoveSpeed = findOffsetByName(j, "CScriptedSequence", "m_flMoveSpeed");
...
CScriptedSequence.m_bSkipFadeIn = findOffsetByName(j, "CScriptedSequence", "m_bSkipFadeIn");
...
// Atribuições para CPulseServerCursor
// CPulseServerCursor Offsets
CPulseServerCursor.m_hActivator = findOffsetByName(j, "CPulseServerCursor", "m_hActivator");
CPulseServerCursor.m_hCaller = findOffsetByName(j, "CPulseServerCursor", "m_hCaller");
...
// Atribuições para CPulseCell_Outflow_PlaySceneBase
// CPulseCell_Outflow_PlaySceneBase Offsets
CPulseCell_Outflow_PlaySceneBase.m_OnFinished = findOffsetByName(j, "CPulseCell_Outflow_PlaySceneBase", "m_OnFinished");
CPulseCell_Outflow_PlaySceneBase.m_OnCanceled = findOffsetByName(j, "CPulseCell_Outflow_PlaySceneBase", "m_OnCanceled");
CPulseCell_Outflow_PlaySceneBase.m_Triggers = findOffsetByName(j, "CPulseCell_Outflow_PlaySceneBase", "m_Triggers");
...
CFuncMoveLinear.m_bAllowMovableNavMeshDockingOnEntireEntity = findOffsetByName(j, "CFuncMoveLinear", "m_bAllowMovableNavMeshDockingOnEntireEntity");
...
CBaseTrigger.m_bUseAsyncQueries = findOffsetByName(j, "CBaseTrigger", "m_bUseAsyncQueries");
...
CBaseCombatCharacter.m_bDeathEventsDispatched = findOffsetByName(j, "CBaseCombatCharacter", "m_bDeathEventsDispatched");
...
CBaseCombatCharacter.m_movementStats = findOffsetByName(j, "CBaseCombatCharacter", "m_movementStats");

// Atribuições para CTestPulseIO
// CTestPulseIO Offsets
CTestPulseIO.m_OnVariantVoid = findOffsetByName(j, "CTestPulseIO", "m_OnVariantVoid");
CTestPulseIO.m_OnVariantBool = findOffsetByName(j, "CTestPulseIO", "m_OnVariantBool");
CTestPulseIO.m_OnVariantInt = findOffsetByName(j, "CTestPulseIO", "m_OnVariantInt");
CTestPulseIO.m_OnVariantFloat = findOffsetByName(j, "CTestPulseIO", "m_OnVariantFloat");
CTestPulseIO.m_OnVariantString = findOffsetByName(j, "CTestPulseIO", "m_OnVariantString");
CTestPulseIO.m_OnVariantColor = findOffsetByName(j, "CTestPulseIO", "m_OnVariantColor");
CTestPulseIO.m_OnVariantVector = findOffsetByName(j, "CTestPulseIO", "m_OnVariantVector");
CTestPulseIO.m_bAllowEmptyInputs = findOffsetByName(j, "CTestPulseIO", "m_bAllowEmptyInputs");
...
CBreakableProp.m_OnStartDeath = findOffsetByName(j, "CBreakableProp", "m_OnStartDeath");
...
CPhysBox.m_vHoverPosePosition = findOffsetByName(j, "CPhysBox", "m_vHoverPosePosition");
CPhysBox.m_angHoverPoseAngles = findOffsetByName(j, "CPhysBox", "m_angHoverPoseAngles");
...
CPhysBox.m_nHoverPoseFlags = findOffsetByName(j, "CPhysBox", "m_nHoverPoseFlags");
...
CEnvExplosion.m_bSuppressParticleImpulse = findOffsetByName(j, "CEnvExplosion", "m_bSuppressParticleImpulse");
...
CBasePlayerPawn.m_hDefaultController = findOffsetByName(j, "CBasePlayerPawn", "m_hDefaultController");
...
CEnvCombinedLightProbeVolume.m_Entity_hLightProbeTexture_AmbientCube = findOffsetByName(j, "CEnvCombinedLightProbeVolume", "m_Entity_hLightProbeTexture_AmbientCube");
CEnvCombinedLightProbeVolume.m_Entity_hLightProbeTexture_SDF = findOffsetByName(j, "CEnvCombinedLightProbeVolume", "m_Entity_hLightProbeTexture_SDF");
CEnvCombinedLightProbeVolume.m_Entity_hLightProbeTexture_SH2_DC = findOffsetByName(j, "CEnvCombinedLightProbeVolume", "m_Entity_hLightProbeTexture_SH2_DC");
CEnvCombinedLightProbeVolume.m_Entity_hLightProbeTexture_SH2_R = findOffsetByName(j, "CEnvCombinedLightProbeVolume", "m_Entity_hLightProbeTexture_SH2_R");
CEnvCombinedLightProbeVolume.m_Entity_hLightProbeTexture_SH2_G = findOffsetByName(j, "CEnvCombinedLightProbeVolume", "m_Entity_hLightProbeTexture_SH2_G");
CEnvCombinedLightProbeVolume.m_Entity_hLightProbeTexture_SH2_B = findOffsetByName(j, "CEnvCombinedLightProbeVolume", "m_Entity_hLightProbeTexture_SH2_B");
...
// Atribuições para CPulseCell_Outflow_ScriptedSequence
// CPulseCell_Outflow_ScriptedSequence Offsets
CPulseCell_Outflow_ScriptedSequence.m_szSyncGroup = findOffsetByName(j, "CPulseCell_Outflow_ScriptedSequence", "m_szSyncGroup");
CPulseCell_Outflow_ScriptedSequence.m_nExpectedNumSequencesInSyncGroup = findOffsetByName(j, "CPulseCell_Outflow_ScriptedSequence", "m_nExpectedNumSequencesInSyncGroup");
CPulseCell_Outflow_ScriptedSequence.m_bEnsureOnNavmeshOnFinish = findOffsetByName(j, "CPulseCell_Outflow_ScriptedSequence", "m_bEnsureOnNavmeshOnFinish");
CPulseCell_Outflow_ScriptedSequence.m_bDontTeleportAtEnd = findOffsetByName(j, "CPulseCell_Outflow_ScriptedSequence", "m_bDontTeleportAtEnd");
CPulseCell_Outflow_ScriptedSequence.m_bDisallowInterrupts = findOffsetByName(j, "CPulseCell_Outflow_ScriptedSequence", "m_bDisallowInterrupts");
CPulseCell_Outflow_ScriptedSequence.m_scriptedSequenceDataMain = findOffsetByName(j, "CPulseCell_Outflow_ScriptedSequence", "m_scriptedSequenceDataMain");
CPulseCell_Outflow_ScriptedSequence.m_vecAdditionalActors = findOffsetByName(j, "CPulseCell_Outflow_ScriptedSequence", "m_vecAdditionalActors");
CPulseCell_Outflow_ScriptedSequence.m_OnFinished = findOffsetByName(j, "CPulseCell_Outflow_ScriptedSequence", "m_OnFinished");
CPulseCell_Outflow_ScriptedSequence.m_OnCanceled = findOffsetByName(j, "CPulseCell_Outflow_ScriptedSequence", "m_OnCanceled");
CPulseCell_Outflow_ScriptedSequence.m_Triggers = findOffsetByName(j, "CPulseCell_Outflow_ScriptedSequence", "m_Triggers");
...
// Atribuições para CDynamicNavConnectionsVolume
// CDynamicNavConnectionsVolume Offsets
CDynamicNavConnectionsVolume.m_iszConnectionTarget = findOffsetByName(j, "CDynamicNavConnectionsVolume", "m_iszConnectionTarget");
CDynamicNavConnectionsVolume.m_vecConnections = findOffsetByName(j, "CDynamicNavConnectionsVolume", "m_vecConnections");
CDynamicNavConnectionsVolume.m_sTransitionType = findOffsetByName(j, "CDynamicNavConnectionsVolume", "m_sTransitionType");
CDynamicNavConnectionsVolume.m_bConnectionsEnabled = findOffsetByName(j, "CDynamicNavConnectionsVolume", "m_bConnectionsEnabled");
CDynamicNavConnectionsVolume.m_flTargetAreaSearchRadius = findOffsetByName(j, "CDynamicNavConnectionsVolume", "m_flTargetAreaSearchRadius");
CDynamicNavConnectionsVolume.m_flUpdateDistance = findOffsetByName(j, "CDynamicNavConnectionsVolume", "m_flUpdateDistance");
CDynamicNavConnectionsVolume.m_flMaxConnectionDistance = findOffsetByName(j, "CDynamicNavConnectionsVolume", "m_flMaxConnectionDistance");
...
CCSPlayerPawn.m_bCommittingSuicideOnTeamChange = findOffsetByName(j, "CCSPlayerPawn", "m_bCommittingSuicideOnTeamChange");
CCSPlayerPawn.m_wasNotKilledNaturally = findOffsetByName(j, "CCSPlayerPawn", "m_wasNotKilledNaturally");
CCSPlayerPawn.m_fImmuneToGunGameDamageTime = findOffsetByName(j, "CCSPlayerPawn", "m_fImmuneToGunGameDamageTime");
CCSPlayerPawn.m_bGunGameImmunity = findOffsetByName(j, "CCSPlayerPawn", "m_bGunGameImmunity");
CCSPlayerPawn.m_fMolotovDamageTime = findOffsetByName(j, "CCSPlayerPawn", "m_fMolotovDamageTime");
CCSPlayerPawn.m_angEyeAngles = findOffsetByName(j, "CCSPlayerPawn", "m_angEyeAngles");

// Atribuições para CEnvLightProbeVolume
// CEnvLightProbeVolume Offsets
CEnvLightProbeVolume.m_Entity_hLightProbeTexture_AmbientCube = findOffsetByName(j, "CEnvLightProbeVolume", "m_Entity_hLightProbeTexture_AmbientCube");
CEnvLightProbeVolume.m_Entity_hLightProbeTexture_SDF = findOffsetByName(j, "CEnvLightProbeVolume", "m_Entity_hLightProbeTexture_SDF");
CEnvLightProbeVolume.m_Entity_hLightProbeTexture_SH2_DC = findOffsetByName(j, "CEnvLightProbeVolume", "m_Entity_hLightProbeTexture_SH2_DC");
CEnvLightProbeVolume.m_Entity_hLightProbeTexture_SH2_R = findOffsetByName(j, "CEnvLightProbeVolume", "m_Entity_hLightProbeTexture_SH2_R");
CEnvLightProbeVolume.m_Entity_hLightProbeTexture_SH2_G = findOffsetByName(j, "CEnvLightProbeVolume", "m_Entity_hLightProbeTexture_SH2_G");
CEnvLightProbeVolume.m_Entity_hLightProbeTexture_SH2_B = findOffsetByName(j, "CEnvLightProbeVolume", "m_Entity_hLightProbeTexture_SH2_B");
...
CPulseGraphInstance_ServerEntity.m_hOwner = findOffsetByName(j, "CPulseGraphInstance_ServerEntity", "m_hOwner");
CPulseGraphInstance_ServerEntity.m_bActivated = findOffsetByName(j, "CPulseGraphInstance_ServerEntity", "m_bActivated");
CPulseGraphInstance_ServerEntity.m_sNameFixupStaticPrefix = findOffsetByName(j, "CPulseGraphInstance_ServerEntity", "m_sNameFixupStaticPrefix");
CPulseGraphInstance_ServerEntity.m_sNameFixupParent = findOffsetByName(j, "CPulseGraphInstance_ServerEntity", "m_sNameFixupParent");
CPulseGraphInstance_ServerEntity.m_sNameFixupLocal = findOffsetByName(j, "CPulseGraphInstance_ServerEntity", "m_sNameFixupLocal");
CPulseGraphInstance_ServerEntity.m_sProceduralWorldNameForRelays = findOffsetByName(j, "CPulseGraphInstance_ServerEntity", "m_sProceduralWorldNameForRelays");
...
CTriggerLook.m_bTestAllVisibleOcclusion = findOffsetByName(j, "CTriggerLook", "m_bTestAllVisibleOcclusion");
...
CMarkupVolumeTagged_Nav.m_nScopes = findOffsetByName(j, "CMarkupVolumeTagged_Nav", "m_nScopes");
...
// Atribuições para CMapSharedEnvironment
// CMapSharedEnvironment Offsets
CMapSharedEnvironment.m_targetMapName = findOffsetByName(j, "CMapSharedEnvironment", "m_targetMapName");
...
CWeaponBaseItem.m_bSequenceInProgress = findOffsetByName(j, "CWeaponBaseItem", "m_bSequenceInProgress");
...
// Atribuições para CPulseCell_Outflow_ListenForEntityOutput__CursorState_t
// CPulseCell_Outflow_ListenForEntityOutput__CursorState_t Offsets
CPulseCell_Outflow_ListenForEntityOutput__CursorState_t.m_entity = findOffsetByName(j, "CPulseCell_Outflow_ListenForEntityOutput__CursorState_t", "m_entity");
...
CMarkupVolumeTagged_NavGame.m_nScopes = findOffsetByName(j, "CMarkupVolumeTagged_NavGame", "m_nScopes");
CMarkupVolumeTagged_NavGame.m_bFloodFillAttribute = findOffsetByName(j, "CMarkupVolumeTagged_NavGame", "m_bFloodFillAttribute");
CMarkupVolumeTagged_NavGame.m_bSplitNavSpace = findOffsetByName(j, "CMarkupVolumeTagged_NavGame", "m_bSplitNavSpace");
...
// Atribuições para CPulseCell_Step_FollowEntity
// CPulseCell_Step_FollowEntity Offsets
CPulseCell_Step_FollowEntity.m_ParamBoneOrAttachName = findOffsetByName(j, "CPulseCell_Step_FollowEntity", "m_ParamBoneOrAttachName");
CPulseCell_Step_FollowEntity.m_ParamBoneOrAttachNameChild = findOffsetByName(j, "CPulseCell_Step_FollowEntity", "m_ParamBoneOrAttachNameChild");
...
CEnvVolumetricFogController.m_TintColor = findOffsetByName(j, "CEnvVolumetricFogController", "m_TintColor");
...
CEnvVolumetricFogController.m_fWindSpeed = findOffsetByName(j, "CEnvVolumetricFogController", "m_fWindSpeed");
CEnvVolumetricFogController.m_vWindDirection = findOffsetByName(j, "CEnvVolumetricFogController", "m_vWindDirection");
...
// Atribuições para CPulseCell_Step_SetAnimGraphParam
// CPulseCell_Step_SetAnimGraphParam Offsets
CPulseCell_Step_SetAnimGraphParam.m_ParamName = findOffsetByName(j, "CPulseCell_Step_SetAnimGraphParam", "m_ParamName");
...
// Atribuições para CPulseCell_Outflow_ListenForEntityOutput
// CPulseCell_Outflow_ListenForEntityOutput Offsets
CPulseCell_Outflow_ListenForEntityOutput.m_OnFired = findOffsetByName(j, "CPulseCell_Outflow_ListenForEntityOutput", "m_OnFired");
CPulseCell_Outflow_ListenForEntityOutput.m_OnCanceled = findOffsetByName(j, "CPulseCell_Outflow_ListenForEntityOutput", "m_OnCanceled");
CPulseCell_Outflow_ListenForEntityOutput.m_strEntityOutput = findOffsetByName(j, "CPulseCell_Outflow_ListenForEntityOutput", "m_strEntityOutput");
CPulseCell_Outflow_ListenForEntityOutput.m_strEntityOutputParam = findOffsetByName(j, "CPulseCell_Outflow_ListenForEntityOutput", "m_strEntityOutputParam");
CPulseCell_Outflow_ListenForEntityOutput.m_bListenUntilCanceled = findOffsetByName(j, "CPulseCell_Outflow_ListenForEntityOutput", "m_bListenUntilCanceled");

// Atribuições para CRotatorTarget
// CRotatorTarget Offsets
CRotatorTarget.m_OnArrivedAt = findOffsetByName(j, "CRotatorTarget", "m_OnArrivedAt");
CRotatorTarget.m_eSpace = findOffsetByName(j, "CRotatorTarget", "m_eSpace");
...
CLogicCollisionPair.m_includeHierarchy = findOffsetByName(j, "CLogicCollisionPair", "m_includeHierarchy");
...
// Atribuições para CPulseCell_Outflow_ScriptedSequence__CursorState_t
// CPulseCell_Outflow_ScriptedSequence__CursorState_t Offsets
CPulseCell_Outflow_ScriptedSequence__CursorState_t.m_scriptedSequence = findOffsetByName(j, "CPulseCell_Outflow_ScriptedSequence__CursorState_t", "m_scriptedSequence");
...
CPropDoorRotating.m_eDefaultCheckDirection = findOffsetByName(j, "CPropDoorRotating", "m_eDefaultCheckDirection");
...
// Atribuições para CPulseCell_SoundEventStart
// CPulseCell_SoundEventStart Offsets
CPulseCell_SoundEventStart.m_Type = findOffsetByName(j, "CPulseCell_SoundEventStart", "m_Type");
...
CCSWeaponBaseGun.m_nRevolverCylinderIdx = findOffsetByName(j, "CCSWeaponBaseGun", "m_nRevolverCylinderIdx");
...
CEnvVolumetricFogVolume.m_bIndirectUseLPVs = findOffsetByName(j, "CEnvVolumetricFogVolume", "m_bIndirectUseLPVs");
...
CEnvVolumetricFogVolume.m_TintColor = findOffsetByName(j, "CEnvVolumetricFogVolume", "m_TintColor");
CEnvVolumetricFogVolume.m_bOverrideTintColor = findOffsetByName(j, "CEnvVolumetricFogVolume", "m_bOverrideTintColor");
...
CRagdollProp.m_ragEnabled = findOffsetByName(j, "CRagdollProp", "m_ragEnabled");
...
CRagdollProp.m_bAllowStretch = findOffsetByName(j, "CRagdollProp", "m_bAllowStretch");
...
CCSGameRules.m_ullLocalMatchID = findOffsetByName(j, "CCSGameRules", "m_ullLocalMatchID");
...
CCSGameRules.m_nCTsAliveAtFreezetimeEnd = findOffsetByName(j, "CCSGameRules", "m_nCTsAliveAtFreezetimeEnd");
CCSGameRules.m_nTerroristsAliveAtFreezetimeEnd = findOffsetByName(j, "CCSGameRules", "m_nTerroristsAliveAtFreezetimeEnd");
...
CPhysConstraint.m_bTreatEntity1AsInfiniteMass = findOffsetByName(j, "CPhysConstraint", "m_bTreatEntity1AsInfiniteMass");
...
CCSWeaponBase.m_iWeaponGameplayAnimState = findOffsetByName(j, "CCSWeaponBase", "m_iWeaponGameplayAnimState");
CCSWeaponBase.m_flWeaponGameplayAnimStateTimestamp = findOffsetByName(j, "CCSWeaponBase", "m_flWeaponGameplayAnimStateTimestamp");
CCSWeaponBase.m_flInspectCancelCompleteTime = findOffsetByName(j, "CCSWeaponBase", "m_flInspectCancelCompleteTime");
CCSWeaponBase.m_bInspectPending = findOffsetByName(j, "CCSWeaponBase", "m_bInspectPending");
CCSWeaponBase.m_bInspectShouldLoop = findOffsetByName(j, "CCSWeaponBase", "m_bInspectShouldLoop");
...
CCSWeaponBase.m_bWasActiveWeaponWhenDropped = findOffsetByName(j, "CCSWeaponBase", "m_bWasActiveWeaponWhenDropped");
...
CCSWeaponBase.m_flLastShakeTime = findOffsetByName(j, "CCSWeaponBase", "m_flLastShakeTime");
...
CInfoSpawnGroupLoadUnload.m_bAutoActivate = findOffsetByName(j, "CInfoSpawnGroupLoadUnload", "m_bAutoActivate");
CInfoSpawnGroupLoadUnload.m_bUnloadingStarted = findOffsetByName(j, "CInfoSpawnGroupLoadUnload", "m_bUnloadingStarted");
CInfoSpawnGroupLoadUnload.m_bQueueActiveSpawnGroupChange = findOffsetByName(j, "CInfoSpawnGroupLoadUnload", "m_bQueueActiveSpawnGroupChange");
CInfoSpawnGroupLoadUnload.m_bQueueFinishLoading = findOffsetByName(j, "CInfoSpawnGroupLoadUnload", "m_bQueueFinishLoading");
...
// Atribuições para CPulseCell_Outflow_ListenForAnimgraphTag
// CPulseCell_Outflow_ListenForAnimgraphTag Offsets
CPulseCell_Outflow_ListenForAnimgraphTag.m_OnStart = findOffsetByName(j, "CPulseCell_Outflow_ListenForAnimgraphTag", "m_OnStart");
CPulseCell_Outflow_ListenForAnimgraphTag.m_OnEnd = findOffsetByName(j, "CPulseCell_Outflow_ListenForAnimgraphTag", "m_OnEnd");
CPulseCell_Outflow_ListenForAnimgraphTag.m_OnCanceled = findOffsetByName(j, "CPulseCell_Outflow_ListenForAnimgraphTag", "m_OnCanceled");
CPulseCell_Outflow_ListenForAnimgraphTag.m_TagName = findOffsetByName(j, "CPulseCell_Outflow_ListenForAnimgraphTag", "m_TagName");
...
CBaseModelEntity.m_nDestructiblePartInitialStateDestructed0_PartIndex = findOffsetByName(j, "CBaseModelEntity", "m_nDestructiblePartInitialStateDestructed0_PartIndex");
CBaseModelEntity.m_nDestructiblePartInitialStateDestructed1_PartIndex = findOffsetByName(j, "CBaseModelEntity", "m_nDestructiblePartInitialStateDestructed1_PartIndex");
CBaseModelEntity.m_nDestructiblePartInitialStateDestructed2_PartIndex = findOffsetByName(j, "CBaseModelEntity", "m_nDestructiblePartInitialStateDestructed2_PartIndex");
...
CPlantedC4.m_bAbortDetonationBecauseWorldIsFrozen = findOffsetByName(j, "CPlantedC4", "m_bAbortDetonationBecauseWorldIsFrozen");
...
CBaseEntity.m_bGravityDisabled = findOffsetByName(j, "CBaseEntity", "m_bGravityDisabled");
CBaseEntity.m_bAnimatedEveryTick = findOffsetByName(j, "CBaseEntity", "m_bAnimatedEveryTick");
CBaseEntity.m_flActualGravityScale = findOffsetByName(j, "CBaseEntity", "m_flActualGravityScale");
CBaseEntity.m_bGravityActuallyDisabled = findOffsetByName(j, "CBaseEntity", "m_bGravityActuallyDisabled");
...
CBaseEntity.m_pPulseGraphInstance = findOffsetByName(j, "CBaseEntity", "m_pPulseGraphInstance");
...
CMarkupVolumeWithRef.m_vRefPosEntitySpace = findOffsetByName(j, "CMarkupVolumeWithRef", "m_vRefPosEntitySpace");
CMarkupVolumeWithRef.m_vRefPosWorldSpace = findOffsetByName(j, "CMarkupVolumeWithRef", "m_vRefPosWorldSpace");
...
// Atribuições para CEnvWindController
// CEnvWindController Offsets
CEnvWindController.m_EnvWindShared = findOffsetByName(j, "CEnvWindController", "m_EnvWindShared");
CEnvWindController.m_fDirectionVariation = findOffsetByName(j, "CEnvWindController", "m_fDirectionVariation");
CEnvWindController.m_fSpeedVariation = findOffsetByName(j, "CEnvWindController", "m_fSpeedVariation");
CEnvWindController.m_fTurbulence = findOffsetByName(j, "CEnvWindController", "m_fTurbulence");
CEnvWindController.m_fVolumeHalfExtentXY = findOffsetByName(j, "CEnvWindController", "m_fVolumeHalfExtentXY");
CEnvWindController.m_fVolumeHalfExtentZ = findOffsetByName(j, "CEnvWindController", "m_fVolumeHalfExtentZ");
CEnvWindController.m_nVolumeResolutionXY = findOffsetByName(j, "CEnvWindController", "m_nVolumeResolutionXY");
CEnvWindController.m_nVolumeResolutionZ = findOffsetByName(j, "CEnvWindController", "m_nVolumeResolutionZ");
CEnvWindController.m_nClipmapLevels = findOffsetByName(j, "CEnvWindController", "m_nClipmapLevels");
CEnvWindController.m_bIsMaster = findOffsetByName(j, "CEnvWindController", "m_bIsMaster");
CEnvWindController.m_bFirstTime = findOffsetByName(j, "CEnvWindController", "m_bFirstTime");
...
CPhysMotor.m_nameAnchor = findOffsetByName(j, "CPhysMotor", "m_nameAnchor");
CPhysMotor.m_hAttachedObject = findOffsetByName(j, "CPhysMotor", "m_hAttachedObject");
CPhysMotor.m_hAnchorObject = findOffsetByName(j, "CPhysMotor", "m_hAnchorObject");
CPhysMotor.m_spinUp = findOffsetByName(j, "CPhysMotor", "m_spinUp");
CPhysMotor.m_spinDown = findOffsetByName(j, "CPhysMotor", "m_spinDown");
CPhysMotor.m_flMotorFriction = findOffsetByName(j, "CPhysMotor", "m_flMotorFriction");
...
CPhysMotor.m_flTorqueScale = findOffsetByName(j, "CPhysMotor", "m_flTorqueScale");
CPhysMotor.m_flTargetSpeed = findOffsetByName(j, "CPhysMotor", "m_flTargetSpeed");
CPhysMotor.m_flSpeedWhenSpinUpOrSpinDownStarted = findOffsetByName(j, "CPhysMotor", "m_flSpeedWhenSpinUpOrSpinDownStarted");
...
CPhysExplosion.m_bAffectInvulnerableEnts = findOffsetByName(j, "CPhysExplosion", "m_bAffectInvulnerableEnts");
...
CSplineConstraint.m_hSplineEntity = findOffsetByName(j, "CSplineConstraint", "m_hSplineEntity");
CSplineConstraint.m_bEnableLateralConstraint = findOffsetByName(j, "CSplineConstraint", "m_bEnableLateralConstraint");
CSplineConstraint.m_bEnableVerticalConstraint = findOffsetByName(j, "CSplineConstraint", "m_bEnableVerticalConstraint");
CSplineConstraint.m_bEnableAngularConstraint = findOffsetByName(j, "CSplineConstraint", "m_bEnableAngularConstraint");
CSplineConstraint.m_bEnableLimit = findOffsetByName(j, "CSplineConstraint", "m_bEnableLimit");
CSplineConstraint.m_bFireEventsOnPath = findOffsetByName(j, "CSplineConstraint", "m_bFireEventsOnPath");
CSplineConstraint.m_flLinearFrequency = findOffsetByName(j, "CSplineConstraint", "m_flLinearFrequency");
CSplineConstraint.m_flLinarDampingRatio = findOffsetByName(j, "CSplineConstraint", "m_flLinarDampingRatio");
CSplineConstraint.m_flJointFriction = findOffsetByName(j, "CSplineConstraint", "m_flJointFriction");
CSplineConstraint.m_flTransitionTime = findOffsetByName(j, "CSplineConstraint", "m_flTransitionTime");
CSplineConstraint.m_vPreSolveAnchorPos = findOffsetByName(j, "CSplineConstraint", "m_vPreSolveAnchorPos");
CSplineConstraint.m_StartTransitionTime = findOffsetByName(j, "CSplineConstraint", "m_StartTransitionTime");
CSplineConstraint.m_vTangentSpaceAnchorAtTransitionStart = findOffsetByName(j, "CSplineConstraint", "m_vTangentSpaceAnchorAtTransitionStart");
...
CPointClientUIWorldPanel.m_bVisibleWhenParentNoDraw = findOffsetByName(j, "CPointClientUIWorldPanel", "m_bVisibleWhenParentNoDraw");
...
CPhysFixed.m_sBoneName1 = findOffsetByName(j, "CPhysFixed", "m_sBoneName1");
CPhysFixed.m_sBoneName2 = findOffsetByName(j, "CPhysFixed", "m_sBoneName2");
...
// Atribuições para CEnvWindVolume
// CEnvWindVolume Offsets
CEnvWindVolume.m_bActive = findOffsetByName(j, "CEnvWindVolume", "m_bActive");
CEnvWindVolume.m_vBoxMins = findOffsetByName(j, "CEnvWindVolume", "m_vBoxMins");
CEnvWindVolume.m_vBoxMaxs = findOffsetByName(j, "CEnvWindVolume", "m_vBoxMaxs");
CEnvWindVolume.m_bStartDisabled = findOffsetByName(j, "CEnvWindVolume", "m_bStartDisabled");
CEnvWindVolume.m_nShape = findOffsetByName(j, "CEnvWindVolume", "m_nShape");
CEnvWindVolume.m_fWindSpeedMultiplier = findOffsetByName(j, "CEnvWindVolume", "m_fWindSpeedMultiplier");
CEnvWindVolume.m_fWindTurbulenceMultiplier = findOffsetByName(j, "CEnvWindVolume", "m_fWindTurbulenceMultiplier");
CEnvWindVolume.m_fWindSpeedVariationMultiplier = findOffsetByName(j, "CEnvWindVolume", "m_fWindSpeedVariationMultiplier");
CEnvWindVolume.m_fWindDirectionVariationMultiplier = findOffsetByName(j, "CEnvWindVolume", "m_fWindDirectionVariationMultiplier");
...
CWeaponCZ75a.m_bMagazineRemoved = findOffsetByName(j, "CWeaponCZ75a", "m_bMagazineRemoved");
...
CRetakeGameRules.m_hBombPlanter = findOffsetByName(j, "CRetakeGameRules", "m_hBombPlanter");
...
CSmokeGrenadeProjectile.m_bDidGroundScorch = findOffsetByName(j, "CSmokeGrenadeProjectile", "m_bDidGroundScorch");
...
CBaseDoor.m_bNoNPCs = findOffsetByName(j, "CBaseDoor", "m_bNoNPCs");
...
CBarnLight.m_nLightPathUniqueId = findOffsetByName(j, "CBarnLight", "m_nLightPathUniqueId");
CBarnLight.m_nLightMapUniqueId = findOffsetByName(j, "CBarnLight", "m_nLightMapUniqueId");
...
CFuncMover.m_hPrevPathMover = findOffsetByName(j, "CFuncMover", "m_hPrevPathMover");
...
CFuncMover.m_nOriginalOrientationIndex = findOffsetByName(j, "CFuncMover", "m_nOriginalOrientationIndex");
CFuncMover.m_bCreateMovableNavMesh = findOffsetByName(j, "CFuncMover", "m_bCreateMovableNavMesh");
CFuncMover.m_bAllowMovableNavMeshDockingOnEntireEntity = findOffsetByName(j, "CFuncMover", "m_bAllowMovableNavMeshDockingOnEntireEntity");
CFuncMover.m_OnNodePassed = findOffsetByName(j, "CFuncMover", "m_OnNodePassed");
CFuncMover.m_iszOrientationMatchEntityName = findOffsetByName(j, "CFuncMover", "m_iszOrientationMatchEntityName");
CFuncMover.m_hOrientationMatchEntity = findOffsetByName(j, "CFuncMover", "m_hOrientationMatchEntity");
CFuncMover.m_flTimeToTraverseToNextNode = findOffsetByName(j, "CFuncMover", "m_flTimeToTraverseToNextNode");
CFuncMover.m_vLerpToNewPosStartInPathEntitySpace = findOffsetByName(j, "CFuncMover", "m_vLerpToNewPosStartInPathEntitySpace");
CFuncMover.m_vLerpToNewPosEndInPathEntitySpace = findOffsetByName(j, "CFuncMover", "m_vLerpToNewPosEndInPathEntitySpace");
CFuncMover.m_flLerpToPositionT = findOffsetByName(j, "CFuncMover", "m_flLerpToPositionT");
CFuncMover.m_flLerpToPositionDeltaT = findOffsetByName(j, "CFuncMover", "m_flLerpToPositionDeltaT");
CFuncMover.m_OnLerpToPositionComplete = findOffsetByName(j, "CFuncMover", "m_OnLerpToPositionComplete");
CFuncMover.m_bIsPaused = findOffsetByName(j, "CFuncMover", "m_bIsPaused");
CFuncMover.m_eTransitionedToPathNodeAction = findOffsetByName(j, "CFuncMover", "m_eTransitionedToPathNodeAction");
CFuncMover.m_nDelayedTeleportToNode = findOffsetByName(j, "CFuncMover", "m_nDelayedTeleportToNode");
CFuncMover.m_bIsVerboseLogging = findOffsetByName(j, "CFuncMover", "m_bIsVerboseLogging");
CFuncMover.m_hFollowEntity = findOffsetByName(j, "CFuncMover", "m_hFollowEntity");
CFuncMover.m_flFollowDistance = findOffsetByName(j, "CFuncMover", "m_flFollowDistance");
CFuncMover.m_flFollowMinimumSpeed = findOffsetByName(j, "CFuncMover", "m_flFollowMinimumSpeed");
CFuncMover.m_flCurFollowEntityT = findOffsetByName(j, "CFuncMover", "m_flCurFollowEntityT");
CFuncMover.m_flCurFollowSpeed = findOffsetByName(j, "CFuncMover", "m_flCurFollowSpeed");
CFuncMover.m_strOrientationFaceEntityName = findOffsetByName(j, "CFuncMover", "m_strOrientationFaceEntityName");
CFuncMover.m_hOrientationFaceEntity = findOffsetByName(j, "CFuncMover", "m_hOrientationFaceEntity");
CFuncMover.m_OnStart = findOffsetByName(j, "CFuncMover", "m_OnStart");
CFuncMover.m_OnStartForward = findOffsetByName(j, "CFuncMover", "m_OnStartForward");
CFuncMover.m_OnStartReverse = findOffsetByName(j, "CFuncMover", "m_OnStartReverse");
CFuncMover.m_OnStop = findOffsetByName(j, "CFuncMover", "m_OnStop");
CFuncMover.m_OnStopped = findOffsetByName(j, "CFuncMover", "m_OnStopped");
...
CPhysicsProp.m_flLastBurn = findOffsetByName(j, "CPhysicsProp", "m_flLastBurn");
CPhysicsProp.m_nDynamicContinuousContactBehavior = findOffsetByName(j, "CPhysicsProp", "m_nDynamicContinuousContactBehavior");
...
CPhysicsProp.m_bAttachedToReferenceFrame = findOffsetByName(j, "CPhysicsProp", "m_bAttachedToReferenceFrame");
...
CFuncNavObstruction.m_bUseAsyncObstacleUpdate = findOffsetByName(j, "CFuncNavObstruction", "m_bUseAsyncObstacleUpdate");
...
CPhysWheelConstraint.m_hSteeringMimicsEntity = findOffsetByName(j, "CPhysWheelConstraint", "m_hSteeringMimicsEntity");
...
// Atribuições para CPulseCell_Outflow_PlaySceneBase__CursorState_t
// CPulseCell_Outflow_PlaySceneBase__CursorState_t Offsets
CPulseCell_Outflow_PlaySceneBase__CursorState_t.m_sceneInstance = findOffsetByName(j, "CPulseCell_Outflow_PlaySceneBase__CursorState_t", "m_sceneInstance");
CPulseCell_Outflow_PlaySceneBase__CursorState_t.m_mainActor = findOffsetByName(j, "CPulseCell_Outflow_PlaySceneBase__CursorState_t", "m_mainActor");
...
// Atribuições para CPulseCell_Outflow_PlaySequence
// CPulseCell_Outflow_PlaySequence Offsets
CPulseCell_Outflow_PlaySequence.m_ParamSequenceName = findOffsetByName(j, "CPulseCell_Outflow_PlaySequence", "m_ParamSequenceName");
...
// Atribuições para CFuncRotator
// CFuncRotator Offsets
CFuncRotator.m_hRotatorTarget = findOffsetByName(j, "CFuncRotator", "m_hRotatorTarget");
CFuncRotator.m_bIsRotating = findOffsetByName(j, "CFuncRotator", "m_bIsRotating");
CFuncRotator.m_bIsReversing = findOffsetByName(j, "CFuncRotator", "m_bIsReversing");
CFuncRotator.m_flTimeToReachMaxSpeed = findOffsetByName(j, "CFuncRotator", "m_flTimeToReachMaxSpeed");
CFuncRotator.m_flTimeToReachZeroSpeed = findOffsetByName(j, "CFuncRotator", "m_flTimeToReachZeroSpeed");
CFuncRotator.m_flDistanceAlongArcTraveled = findOffsetByName(j, "CFuncRotator", "m_flDistanceAlongArcTraveled");
CFuncRotator.m_flTimeToWaitOscillate = findOffsetByName(j, "CFuncRotator", "m_flTimeToWaitOscillate");
CFuncRotator.m_flTimeRotationStart = findOffsetByName(j, "CFuncRotator", "m_flTimeRotationStart");
CFuncRotator.m_qLSPrevChange = findOffsetByName(j, "CFuncRotator", "m_qLSPrevChange");
CFuncRotator.m_qWSPrev = findOffsetByName(j, "CFuncRotator", "m_qWSPrev");
CFuncRotator.m_qWSInit = findOffsetByName(j, "CFuncRotator", "m_qWSInit");
CFuncRotator.m_qLSInit = findOffsetByName(j, "CFuncRotator", "m_qLSInit");
CFuncRotator.m_qLSOrientation = findOffsetByName(j, "CFuncRotator", "m_qLSOrientation");
CFuncRotator.m_OnRotationStarted = findOffsetByName(j, "CFuncRotator", "m_OnRotationStarted");
CFuncRotator.m_OnRotationCompleted = findOffsetByName(j, "CFuncRotator", "m_OnRotationCompleted");
CFuncRotator.m_OnOscillate = findOffsetByName(j, "CFuncRotator", "m_OnOscillate");
CFuncRotator.m_OnOscillateStartArrive = findOffsetByName(j, "CFuncRotator", "m_OnOscillateStartArrive");
CFuncRotator.m_OnOscillateStartDepart = findOffsetByName(j, "CFuncRotator", "m_OnOscillateStartDepart");
CFuncRotator.m_OnOscillateEndArrive = findOffsetByName(j, "CFuncRotator", "m_OnOscillateEndArrive");
CFuncRotator.m_OnOscillateEndDepart = findOffsetByName(j, "CFuncRotator", "m_OnOscillateEndDepart");
CFuncRotator.m_bOscillateDepart = findOffsetByName(j, "CFuncRotator", "m_bOscillateDepart");
CFuncRotator.m_nOscillateCount = findOffsetByName(j, "CFuncRotator", "m_nOscillateCount");
CFuncRotator.m_eRotateType = findOffsetByName(j, "CFuncRotator", "m_eRotateType");
CFuncRotator.m_ePrevRotateType = findOffsetByName(j, "CFuncRotator", "m_ePrevRotateType");
CFuncRotator.m_bHasTargetOverride = findOffsetByName(j, "CFuncRotator", "m_bHasTargetOverride");
CFuncRotator.m_qOrientationOverride = findOffsetByName(j, "CFuncRotator", "m_qOrientationOverride");
CFuncRotator.m_eSpaceOverride = findOffsetByName(j, "CFuncRotator", "m_eSpaceOverride");
CFuncRotator.m_qAngularVelocity = findOffsetByName(j, "CFuncRotator", "m_qAngularVelocity");
CFuncRotator.m_vLookAtForcedUp = findOffsetByName(j, "CFuncRotator", "m_vLookAtForcedUp");
CFuncRotator.m_strRotatorTarget = findOffsetByName(j, "CFuncRotator", "m_strRotatorTarget");
CFuncRotator.m_bRecordHistory = findOffsetByName(j, "CFuncRotator", "m_bRecordHistory");
CFuncRotator.m_vecRotatorHistory = findOffsetByName(j, "CFuncRotator", "m_vecRotatorHistory");
...
CBasePropDoor.m_bNoNPCs = findOffsetByName(j, "CBasePropDoor", "m_bNoNPCs");
...
CMarkupVolumeTagged.m_GroupNames = findOffsetByName(j, "CMarkupVolumeTagged", "m_GroupNames");
CMarkupVolumeTagged.m_Tags = findOffsetByName(j, "CMarkupVolumeTagged", "m_Tags");
...
CTriggerLerpObject.m_OnDetached = findOffsetByName(j, "CTriggerLerpObject", "m_OnDetached");
...
// Atribuições para SteamAudioReverbClusteringSettings_t
// SteamAudioReverbClusteringSettings_t Offsets
SteamAudioReverbClusteringSettings_t.m_bEnableClustering = findOffsetByName(j, "SteamAudioReverbClusteringSettings_t", "m_bEnableClustering");
SteamAudioReverbClusteringSettings_t.m_nCubeMapResolution = findOffsetByName(j, "SteamAudioReverbClusteringSettings_t", "m_nCubeMapResolution");
SteamAudioReverbClusteringSettings_t.m_flDepthThreshold = findOffsetByName(j, "SteamAudioReverbClusteringSettings_t", "m_flDepthThreshold");

// Atribuições para SteamAudioCustomDataDimensionsSettings_t
// SteamAudioCustomDataDimensionsSettings_t Offsets
SteamAudioCustomDataDimensionsSettings_t.m_nAmbisonicsOrderOutsideField = findOffsetByName(j, "SteamAudioCustomDataDimensionsSettings_t", "m_nAmbisonicsOrderOutsideField");
SteamAudioCustomDataDimensionsSettings_t.m_nAmbisonicsOrderInsideSizeField = findOffsetByName(j, "SteamAudioCustomDataDimensionsSettings_t", "m_nAmbisonicsOrderInsideSizeField");
SteamAudioCustomDataDimensionsSettings_t.m_flOutsideThreshold = findOffsetByName(j, "SteamAudioCustomDataDimensionsSettings_t", "m_flOutsideThreshold");
SteamAudioCustomDataDimensionsSettings_t.m_flSizeThreshold = findOffsetByName(j, "SteamAudioCustomDataDimensionsSettings_t", "m_flSizeThreshold");
SteamAudioCustomDataDimensionsSettings_t.m_flInsideThreshold = findOffsetByName(j, "SteamAudioCustomDataDimensionsSettings_t", "m_flInsideThreshold");

// Atribuições para SteamAudioPathSettings_t
// SteamAudioPathSettings_t Offsets
SteamAudioPathSettings_t.m_nNumVisSamples = findOffsetByName(j, "SteamAudioPathSettings_t", "m_nNumVisSamples");
SteamAudioPathSettings_t.m_flProbeVisRadius = findOffsetByName(j, "SteamAudioPathSettings_t", "m_flProbeVisRadius");
SteamAudioPathSettings_t.m_flProbeVisThreshold = findOffsetByName(j, "SteamAudioPathSettings_t", "m_flProbeVisThreshold");
SteamAudioPathSettings_t.m_flProbePathRange = findOffsetByName(j, "SteamAudioPathSettings_t", "m_flProbePathRange");

// Atribuições para CSteamAudioAmbisonicsField
// CSteamAudioAmbisonicsField Offsets
CSteamAudioAmbisonicsField.m_field = findOffsetByName(j, "CSteamAudioAmbisonicsField", "m_field");

// Atribuições para CSteamAudioBakedPathingData
...
SteamAudioReverbSettings_t.m_nNumRays = findOffsetByName(j, "SteamAudioReverbSettings_t", "m_nNumRays");
SteamAudioReverbSettings_t.m_nNumBounces = findOffsetByName(j, "SteamAudioReverbSettings_t", "m_nNumBounces");
SteamAudioReverbSettings_t.m_flIRDuration = findOffsetByName(j, "SteamAudioReverbSettings_t", "m_flIRDuration");
SteamAudioReverbSettings_t.m_nAmbisonicsOrder = findOffsetByName(j, "SteamAudioReverbSettings_t", "m_nAmbisonicsOrder");

// Atribuições para CSteamAudioProbeData
// CSteamAudioProbeData Offsets
CSteamAudioProbeData.m_pProbeBatch = findOffsetByName(j, "CSteamAudioProbeData", "m_pProbeBatch");
...
CSteamAudioBakedMaterialsData.m_probes = findOffsetByName(j, "CSteamAudioBakedMaterialsData", "m_probes");
CSteamAudioBakedMaterialsData.m_vecMaterialTokens = findOffsetByName(j, "CSteamAudioBakedMaterialsData", "m_vecMaterialTokens");
CSteamAudioBakedMaterialsData.m_vecMaterialWeights = findOffsetByName(j, "CSteamAudioBakedMaterialsData", "m_vecMaterialWeights");

// Atribuições para CSteamAudioBakedOcclusionData
// CSteamAudioBakedOcclusionData Offsets
CSteamAudioBakedOcclusionData.m_settings = findOffsetByName(j, "CSteamAudioBakedOcclusionData", "m_settings");
CSteamAudioBakedOcclusionData.m_probes = findOffsetByName(j, "CSteamAudioBakedOcclusionData", "m_probes");
CSteamAudioBakedOcclusionData.m_vecPathingRatio = findOffsetByName(j, "CSteamAudioBakedOcclusionData", "m_vecPathingRatio");
CSteamAudioBakedOcclusionData.m_vecPathingDeviation = findOffsetByName(j, "CSteamAudioBakedOcclusionData", "m_vecPathingDeviation");
CSteamAudioBakedOcclusionData.m_vecReflectionRatio = findOffsetByName(j, "CSteamAudioBakedOcclusionData", "m_vecReflectionRatio");

// Atribuições para CSteamAudioBakedReverbData
// CSteamAudioBakedReverbData Offsets
CSteamAudioBakedReverbData.m_nBands = findOffsetByName(j, "CSteamAudioBakedReverbData", "m_nBands");
CSteamAudioBakedReverbData.m_probes = findOffsetByName(j, "CSteamAudioBakedReverbData", "m_probes");
CSteamAudioBakedReverbData.m_grid = findOffsetByName(j, "CSteamAudioBakedReverbData", "m_grid");
CSteamAudioBakedReverbData.m_reverbSettings = findOffsetByName(j, "CSteamAudioBakedReverbData", "m_reverbSettings");
CSteamAudioBakedReverbData.m_reverbClusteringSettings = findOffsetByName(j, "CSteamAudioBakedReverbData", "m_reverbClusteringSettings");
CSteamAudioBakedReverbData.m_reverbCompressionSettings = findOffsetByName(j, "CSteamAudioBakedReverbData", "m_reverbCompressionSettings");
CSteamAudioBakedReverbData.m_clusteredProbes = findOffsetByName(j, "CSteamAudioBakedReverbData", "m_clusteredProbes");
...
CSteamAudioProbeLineSegment.m_vStart = findOffsetByName(j, "CSteamAudioProbeLineSegment", "m_vStart");
CSteamAudioProbeLineSegment.m_vEnd = findOffsetByName(j, "CSteamAudioProbeLineSegment", "m_vEnd");
CSteamAudioProbeLineSegment.m_vecIntervals = findOffsetByName(j, "CSteamAudioProbeLineSegment", "m_vecIntervals");
CSteamAudioProbeLineSegment.m_vecProbeIndices = findOffsetByName(j, "CSteamAudioProbeLineSegment", "m_vecProbeIndices");

// Atribuições para SteamAudioCustomDataOcclusionSettings_t
// SteamAudioCustomDataOcclusionSettings_t Offsets
SteamAudioCustomDataOcclusionSettings_t.m_bEnablePathing = findOffsetByName(j, "SteamAudioCustomDataOcclusionSettings_t", "m_bEnablePathing");
SteamAudioCustomDataOcclusionSettings_t.m_bEnableReflections = findOffsetByName(j, "SteamAudioCustomDataOcclusionSettings_t", "m_bEnableReflections");
SteamAudioCustomDataOcclusionSettings_t.m_nReflectionRays = findOffsetByName(j, "SteamAudioCustomDataOcclusionSettings_t", "m_nReflectionRays");
SteamAudioCustomDataOcclusionSettings_t.m_nReflectionBounces = findOffsetByName(j, "SteamAudioCustomDataOcclusionSettings_t", "m_nReflectionBounces");

// Atribuições para CSteamAudioBakedDimensionsData
// CSteamAudioBakedDimensionsData Offsets
CSteamAudioBakedDimensionsData.m_settings = findOffsetByName(j, "CSteamAudioBakedDimensionsData", "m_settings");
CSteamAudioBakedDimensionsData.m_probes = findOffsetByName(j, "CSteamAudioBakedDimensionsData", "m_probes");
CSteamAudioBakedDimensionsData.m_vecInOut = findOffsetByName(j, "CSteamAudioBakedDimensionsData", "m_vecInOut");
...
CSteamAudioProbeGrid.m_aabb = findOffsetByName(j, "CSteamAudioProbeGrid", "m_aabb");
CSteamAudioProbeGrid.m_flSpacing = findOffsetByName(j, "CSteamAudioProbeGrid", "m_flSpacing");
CSteamAudioProbeGrid.m_nx = findOffsetByName(j, "CSteamAudioProbeGrid", "m_nx");
CSteamAudioProbeGrid.m_ny = findOffsetByName(j, "CSteamAudioProbeGrid", "m_ny");
CSteamAudioProbeGrid.m_nz = findOffsetByName(j, "CSteamAudioProbeGrid", "m_nz");
CSteamAudioProbeGrid.m_vecLineSegments = findOffsetByName(j, "CSteamAudioProbeGrid", "m_vecLineSegments");
CSteamAudioProbeGrid.m_vecProbes = findOffsetByName(j, "CSteamAudioProbeGrid", "m_vecProbes");

// Atribuições para CSteamAudioCompressedReverb
// CSteamAudioCompressedReverb Offsets
CSteamAudioCompressedReverb.m_nChannels = findOffsetByName(j, "CSteamAudioCompressedReverb", "m_nChannels");
CSteamAudioCompressedReverb.m_nBands = findOffsetByName(j, "CSteamAudioCompressedReverb", "m_nBands");
CSteamAudioCompressedReverb.m_nBins = findOffsetByName(j, "CSteamAudioCompressedReverb", "m_nBins");
CSteamAudioCompressedReverb.m_nProbes = findOffsetByName(j, "CSteamAudioCompressedReverb", "m_nProbes");
CSteamAudioCompressedReverb.m_vecNumSingularValues = findOffsetByName(j, "CSteamAudioCompressedReverb", "m_vecNumSingularValues");
CSteamAudioCompressedReverb.m_vecDictionary = findOffsetByName(j, "CSteamAudioCompressedReverb", "m_vecDictionary");
CSteamAudioCompressedReverb.m_vecCompressedData = findOffsetByName(j, "CSteamAudioCompressedReverb", "m_vecCompressedData");
CSteamAudioCompressedReverb.m_pCompressedData = findOffsetByName(j, "CSteamAudioCompressedReverb", "m_pCompressedData");
